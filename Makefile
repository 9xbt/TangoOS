...
CCFLAGS = -m32 -std=gnu11 -ffreestanding -O0 -Wall -Wextra -nostdlib -I kernel -fno-stack-protector -Wno-unused-parameter -fno-stack-check -fno-lto -mno-mmx -mno-sse -mno-sse2 -mno-80387 -mno-red-zone -fsanitize=undefined
...
fs:
	...
	@mkfs.ext2 bin/fs.hdd -L tangoOS 2>&1 >/dev/null | grep -v mke2fs | cat
